...
#define BUILTINS_LIST(F)                                                \
  ...
  F(InserterFree, inserterFree)                                         \
                                                                        \
  /* IndexCreator Calls */                                              \
  F(IndexCreatorInit, indexCreatorInit)                                 \
  F(IndexCreatorInitBind, indexCreatorInitBind)                         \
  F(IndexCreatorGetIndexPR, indexCreatorGetIndexPR)                     \
  F(IndexCreatorIndexInsert, indexCreatorIndexInsert)                   \
  F(IndexCreatorFree, indexCreatorFree)                                 \
                                                                        \
  /* Deleter Calls */                                                   \
